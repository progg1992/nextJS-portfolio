...
const Desktop = React.memo(function Desktop(props) {

    // Use React.memo for performance optimization
    const { nodes, materials } = useGLTF("/models/desktop-transformed.glb");
...
useGLTF.preload('/models/desktop-transformed.glb')